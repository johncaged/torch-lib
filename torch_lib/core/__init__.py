...
from torch_lib.callback import C_SEQ, CallbackContainer, DistributedCallbackContainer
from torch_lib.util import NOTHING, get_device, type_cast, MethodChaining, InvocationDebug, logger, \
    is_nothing, count_params, BaseList
from torch_lib.util.type import NUMBER, INT_SEQ_N
...
class DistributedProxy(Proxy):
    ...
    def set_distributed_context(self):
        from torch_lib.core.context import DistributedContext, DistributedHandlerContext
